...
import 'package:ecommerce_wael/view/widget/items/customlistitems.dart';
import 'package:ecommerce_wael/view/widget/items/listcategoirseitems.dart';
              ...
              builder: (controller) => HandlingDataView(
                  ...
                  widget:!controller.isSearch? GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        ...
                        ['items_id']] = controller.data[index]['favourite'];
