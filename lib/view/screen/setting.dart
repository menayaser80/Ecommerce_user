import 'package:ecommerce_wael/controller/setting%20controller.dart';
...
class Settang extends StatelessWidget {
  const Settang({Key? key}) : super(key: key);
          ...
          Container(
            ...
            child: Card(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                ListTile(
                  onTap: () async{
                 await launchUrl(Uri.parse("tel:+201030659884"));
                  },
